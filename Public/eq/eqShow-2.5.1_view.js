        ...
        "view" == c.mode && b.properties.url && $(a).click(function() {
            {
                ...
                isNaN(a) ? window.open(a) : pageScroll(a)
            }
        })
...
! function($) {
    ...
    function appendLastPage(a, b) {
        ...
        if (a.obj.createTime > 14165028e5 && !a.obj.image.hideEqAd)
            if (a.obj.image.isAdvancedUser) d = d.replace(/id=16060/, "id=" + a.obj.id), e = e.replace(/id=16060/, "id=" + a.obj.id), b[b.length - 1].elements || (b[b.length - 1].elements = []), b[b.length - 1].elements.push(JSON.parse(d)), b[b.length - 1].elements.push(JSON.parse(e)), ad = 2;
