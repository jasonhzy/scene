...
! function(a, b, c) {
    ...
    f.prototype = {
        ...
        function(b) {
            ...
            d.addInterceptor(function(a, b) {
                ...
                "view" == d.mode && c.properties.url && $(b).bind("mousedown touchstart", function(b) {
                    p = !0, b.preventDefault(), b.stopPropagation(), eqxiu.setEndCount(); {
                ...
                for (var b = $(a).find("a[data]"), c = 0; c < b.length; c++)
                    if (b[c] && "view" == d.mode) {
                        ...
                        var e = $(b[c]).attr("data");
                        ! function(a) {
                            $(b[c]).bind("mousedown touchstart", function(b) {
                                p = !0, b.stopPropagation(), eqxiu.setEndCount(), eqxiu.pageScroll(a)
                            })
                        }(e)
                    }
    ...
    b.module("app", ["ngRoute", "home", "sample", "main", "reg", "scene", "my", "data", "error", "usercenter", "ui.bootstrap", "ui.grid", "ui.grid.selection", "ngSanitize", "ui.select", "services.i18nNotifications", "services.httpRequestTracker", "services.sample", "security", "app.upload", "templates-app", "templates-common", "ui.sortable", "I18N.MESSAGES", "app.directives.notification"]), b.module("app").config(["$routeProvider", "$locationProvider", "securityAuthorizationProvider", "uiSelectConfig",
        ...
        b.module("scene.create").controller("CreateSceneCtrl", ["$timeout", "$compile", "$rootScope", "$scope", "$routeParams", "$route", "$location", "sceneService", "pageTplService", "$modal", "ModalService", "security", "$window", "i18nNotifications", "historyService",
            function(c, d, e, f, g, h, j, k, l, m, n, o, p, q, s) {
                function t(a, c, d) {
                ...
                f.saveScene = function(a, c) {
                    if (!C) {
                        if (C = !0, x == JSON.stringify(f.tpl)) return c && c(), a && (!f.tpl.obj.scene.publishTime || f.tpl.obj.scene.updateTime > f.tpl.obj.scene.publishTime ? u() : q.pushForCurrentRoute("scene.save.success.published", "notify.success")), void(C = !1);
                    ...
                    return f.tpl.obj.scene.publishTime && f.tpl.obj.scene.updateTime <= f.tpl.obj.scene.publishTime && x == b.toJson(f.tpl) ? void j.path("my/scene/" + f.sceneId) : void f.saveScene(null, function() {
                        k.publishScene(f.tpl.obj.sceneId).then(function(a) {
                            a.data.success && (q.pushForNextRoute("scene.publish.success", "notify.success"), r = !1, j.path(f.tpl.obj.scene.publishTime ? "my/scene/" + f.sceneId : "my/sceneSetting/" + f.sceneId))
                        })
                    })
                    ...
                    if (f.userProperty) {
                        ...
                        var a = f.mySceneId || f.userPropertyObj;
                        if (a) {
                            {
                                f.mySceneId || f.userPropertyObj.myTplId
                            }
                            D()
                        } else D()
                    }
                ...
                var D = function() {
                        ...
                        a.sceneId = f.mySceneId ? f.mySceneId : null, k.saveMyTpl(a).then(function(a) {
                            alert("成功生成我的模板");
                            f.mySceneId = a.data.obj, k.previewScene(f.mySceneId).then(function(a) {
                                f.myName[0].active = !0;
                                f.myPageTpls = E[f.mySceneId] = a.data.list
                            })
                        })
                    },
                    E = {};
                f.getPageTplsByMyType = function() {
                    ...
                    var a = f.mySceneId || f.userPropertyObj;
                    if (a) {
                        var b = f.mySceneId || f.userPropertyObj.myTplId;
                        E[b] ? f.myPageTpls = E[b] : k.previewScene(b).then(function(a) {
                ...
                var F = function() {
                    ...
                    G = {},
                    H = function(a) {
                        G[a] ? (f.childCatrgoryList = G[a], f.getPageTplTypestemp(f.childCatrgoryList[0].id, a), F()) : l.getPageTagLabel(a).then(function(b) {
                ...
                f.pageChildLabel = function() {
                    ...
                    var b = function(a) {
                        k.getSceneTpl(a).then(function(a) {
                            f.loading = !1, v = a.data.obj.id, f.tpl.obj.elements = k.getElements(), $("#nr").empty(), s.addPageHistory(f.tpl.obj.id, f.tpl.obj.elements), k.templateEditor.parse({
                                def: f.tpl.obj,
                                appendTo: "#nr",
                                mode: "edit"
                            }), e.$broadcast("dom.changed")
        ...
        }).directive("thumbTpl", ["sceneService",
            function(a) {
                return {
                    scope: {
                        localModel: "=myAttr"
        ...
        function() {
        ...
        ]), b.module("services.scene", ["scene.create.console", "services.history"]), b.module("services.scene").factory("sceneService", ["$http", "$rootScope", "$modal", "$q", "security", "$cacheFactory", "historyService",
            function(a, c, d, e, f, g, h) {
                ...
                E.historyBack = function() {
                    ...
                    $("#nr .edit_area").length && ((a.ctrlKey || a.metaKey) && 90 == a.keyCode && E.historyBack(), (a.ctrlKey || a.metaKey) && 89 == a.keyCode && E.historyForward(), !a.ctrlKey && !a.metaKey || 86 != a.keyCode || !E.elemDefTpl || $("#btn-toolbar")[0] || $(".modal-dialog")[0] || (a.preventDefault(), r && (a.preventDefault(), E.pasteElement(E.originalElemDef, E.copyElemDef))), !a.ctrlKey && !a.metaKey || 67 != a.keyCode || !E.elemDefTpl || $("#btn-toolbar")[0] || $(".modal-dialog")[0] || (a.preventDefault(), E.pageId = G.obj.id, E.sameCopyCount = 0, E.copyElement(E.elemDefTpl)), c.$apply())
                });
                ...
                E.createComp = function(a, b) {
                    ...
                    var c = b.copy(a);
                    r = !0, E.originalElemDef = a, E.copyElemDef = c
                ...
                return F.addInterceptor(function(a, e, g) {
                    function i() {
                        ...
                        return r && b.find(".copy").after($('<li class="paste" role="presentation"><a role="menuitem" tabindex="-1"><div class="fa fa-paste" style="color: #08a1ef;"></div>&nbsp;&nbsp;粘贴</a></li>')), b.find(".edit").click(function(c) {
                ...
                }), E.templateEditor = F, E.getTplById = function(b) {
                    ...
                    if (c.get(b)) {
                        ...
                        k += (/\?/.test(k) ? "&" : "?") + "time=" + l.getTime(), a({
                            ...
                            c.put(a.data.obj.id, $.extend(!0, {}, a)), a.data.obj.scene && a.data.obj.scene.image && a.data.obj.scene.image.bgAudio && (G.obj.scene.image || (G.obj.scene.image = {}), G.obj.scene.image.bgAudio = a.data.obj.scene.image.bgAudio);
                            for (var b = 0; b < a.data.obj.elements.length; b++) {
                                var e = a.data.obj.elements[b];
                                e.id = Math.ceil(100 * Math.random()), e.sceneId = G.obj.sceneId, e.pageId = G.obj.id
                            }
                ...
                }, E.createCustomComp = K, E.openAudioModal = y, E.getElements = function() {
                    return H
