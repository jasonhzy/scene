...
var tplCount = 0,
    copied = !1,
    copyElemDef, originalElemDef, childTouched;
! function() {
...
function(a) {
    ...
    c.addInterceptor(function(a, b) {
        function d(a, b, d) {
            a.css("animation", b + " " + d.duration + "s ease " + d.delay + "s " + (d.countNum ? d.countNum : "")), "view" == c.mode ? (d.count && a.css("animation-iteration-count", "infinite"), a.css("animation-fill-mode", "both")) : (a.css("animation-iteration-count", "1"), a.css("animation-fill-mode", "backwards")), d.linear && a.css("animation-timing-function", "linear")
        }
        ...
        "view" == c.mode && b.properties.url && $(a).bind("mousedown touchstart", function(a) {
            childTouched = !0, a.preventDefault(), a.stopPropagation(), eqxiu.setEndCount(); {
        ...
        for (var b = $(a).find("a[data]"), d = 0; d < b.length; d++)
            if (b[d] && "view" == c.mode) {
                ...
                var e = $(b[d]).attr("data");
                ! function(a) {
                    $(b[d]).bind("mousedown touchstart", function(b) {
                        childTouched = !0, b.stopPropagation(), eqxiu.setEndCount(), eqxiu.pageScroll(a)
                    })
                }(e)
            }
    }), c.bindAfterRenderEvent("6", function(a) {
...
var eqxiu = function() {
    ...
    var e, f, g, h, i, j, k, l = $(window),
        ...
        w = function(a, b, c) {
            ...
            function w() {
                if (u)
                    if (d(e.$currentPage.style, "Transform", "scale(1)"), "0" == b || "1" == b || "2" == b || "6" == b) {
                        var a = s > 0 ? "" : "-";
                        d(e.$activePage.style, "Transform", "translateY(" + a + "100%)")
                    } else {
                        var a = r > 0 ? "" : "-";
                        d(e.$activePage.style, "Transform", "translateX(" + a + "100%)")
                    }
                setTimeout(function() {
            ...
            function y() {
                ...
                }, 500)) : (e._isDisableFlipPage = !1, w())
            }

            function z() {
                if (Math.abs(r) > Math.abs(s) && k())
                    if (r > 0) {
                        if (e._isDisableFlipPrevPage) return;
            ...
            function D() {
                if (Math.abs(s) > Math.abs(r) && k())
                    if (s > 0) {
                        if (e._isDisableFlipNextPage) return;
                        !u || v ? (u = !0, v = !1, e.$activePage && $(e.$activePage).removeClass("z-move z-active"), n ? m = !0 : e.$currentPage.nextElementSibling && e.$currentPage.nextElementSibling.classList.contains("main-page") ? e.$activePage = e.$currentPage.nextElementSibling : (e.$activePage = e._$pages.first().get(0), m = !0)) : m = !0, e.$activePage && e.$activePage.classList.contains("main-page") && (d(e._$app.get(0).style, "perspective", "1000"), d(e._$app.get(0).style, "TransformStyle", "preserve-3d"), $(e.$activePage).addClass("z-active z-move").trigger("active"), d(e.$currentPage.style, "Transform", "translateZ(" + $(".nr").height() / 2 + "px)"), d(e.$activePage.style, "Transform", "rotateX(-90deg) translateZ(-" + $(".nr").height() / 2 + "px)"))
                    } else if (0 > s) {
                    if (e._isDisableFlipNextPage) return;
                    (!u || v) && (u = !0, v = !1, e.$activePage && $(e.$activePage).removeClass("z-move z-active"),
                        n ? m = !0 : e.$currentPage.nextElementSibling && e.$currentPage.nextElementSibling.classList.contains("main-page") ? e.$activePage = e.$currentPage.nextElementSibling : (e.$activePage = e._$pages.first().get(0), m = !0), e.$activePage && e.$activePage.classList.contains("main-page") ? (e._$app.get(0).style.webkitPerspective = "10000px", e._$app.get(0).style.perspective = "10000px", d(e._$app.get(0).style, "TransformStyle", "preserve-3d"), $(e.$activePage).addClass("z-active z-move").trigger("active")) : (d(e.$currentPage.style, "Transform", "translateX(0px) scale(1)"), e.$activePage = null))
                }
            }

            function E() {
                Math.abs(s) > Math.abs(r) && Math.abs(s) > 20 ? (s > 0 ? (e._$app.get(0).style.webkitTransform = "rotateX(89deg)", e._$app.get(0).style.transform = "rotateX(89deg)") : (e._$app.get(0).style.webkitPerspective = "10000px", e._$app.get(0).style.perspective = "10000px", d(e._$app.get(0).style, "TransformStyle", "preserve-3d"), e._$app.get(0).style.webkitTransform = "rotateY(-89deg)", e._$app.get(0).style.transform = "rotateY(-89deg)"), k() || $("#audio_btn").css("opacity", 0), setTimeout(function() {
                    $(e.$activePage).removeClass("z-active z-move").addClass("z-current"), $(e.$currentPage).removeClass("z-current z-move"), e._isDisableFlipPage = !1, e.$currentPage = $(e.$activePage).trigger("current"), $(e.$currentPage).trigger("hide")
                }, 500)) : (e._isDisableFlipPage = !1, w())
            }
            this._$app = a, this._$pages = this._$app.find(".main-page"), this.$currentPage = this._$pages.eq(0), this.$activePage = null, this._isFirstShowPage = !0, this._isInitComplete = !1, this._isDisableFlipPage = !1, this._isDisableFlipPrevPage = !1, this._isDisableFlipNextPage = !1, this._scrollMode = b, this._pageData = c, b = b, e = this, i = o || window.top != window.self ? window.innerWidth : $(".nr").width(), j = o || window.top != window.self ? window.innerHeight : $(".nr").height(),
                function() {
                    ...
                    return console.log(123), childTouched ? !1 : void f(a)
                }).on("mousemove touchmove", function(a) {
                    g(a)
                }).on("mouseup touchend mouseleave", function(a) {
                    return childTouched ? !1 : void h(a)
                }), f = function(a) {
                    o && a && (a = event), e._isDisableFlipPage || (e.$currentPage = e._$pages.filter(".z-current").get(0), n || (activePage = null), e.$currentPage && k() && (t = !0, u = !1, v = !0, r = 0, s = 0, a && "mousedown" == a.type ? (p = a.pageX, q = a.pageY) : a && "touchstart" == a.type && (p = a.touches[0].pageX, q = a.touches[0].pageY), e.$currentPage.classList.add("z-move"), d(e.$currentPage.style, "Transition", "none")))
                }, g = function(a) {
                    o && a && (a = event), t && e._$pages.length > 1 && (a && "mousemove" == a.type ? (r = a.pageX - p, s = a.pageY - q) : a && "touchmove" == a.type && (r = a.touches[0].pageX - p, s = a.touches[0].pageY - q), "0" == b || "2" == b || "1" == b ? x() : "4" == b || "3" == b ? z() : "5" == b ? B() : "6" == b && D())
                }, h = function() {
                    t && k() && (t = !1, e.$activePage ? (e._isDisableFlipPage = !0, e.$currentPage.style.webkitTransition = "-webkit-transform .4s linear", e.$activePage.style.webkitTransition = "-webkit-transform .4s linear", e.$currentPage.style.mozTransition = "-moz-transform .4s linear", e.$activePage.style.mozTransition = "-moz-transform .4s linear", e.$currentPage.style.transition = "transform .4s linear", e.$activePage.style.transition = "transform .4s linear", "0" == b || "2" == b || "1" == b ? y() : "4" == b || "3" == b ? A() : "5" == b ? C() : "6" == b && E()) : e.$currentPage.classList.remove("z-move")), n = !1
                }
        };
    return {
        pageScroll: a,
...
! function($) {
    ...
    function getRequestUrl() {
        var a;
        return a = preview ? PREFIX_URL + "m/scene/preview/" + sceneId : mobileview ? PREFIX_URL + "event/9100?p1=" + sceneId : PREFIX_S1_URL + "eqs/s/" + sceneId, a += (/\?/.test(a) ? "&" : "?") + "time=" + (new Date).getTime()
    }
    ...
    function parseJson(a) {
        ...
        var b = a.list,
            ...
            d = !1,
            e = a.obj.image;
        if (b.length <= 0) return alert("此场景不存在"), void(window.location.href = "http://eqxiu.com");
        customLastPage = !1, appendLastPage(a, b), bindShare(a), document.title = a.obj.name, $("#metaDescription").attr("content", a.obj.name + ", " + a.obj.description + ", 由好站长免费移动场景应用自营销管家提供技术支持"), $(".scene_title").html(a.obj.name);
        for (var f = 1; f <= b.length; f++)
            if ($('<section class="main-page" ><div class="m-img" id="page' + f + '"></div></section>').appendTo(".nr"), b.length > 1 && (0 == pageMode || 1 == pageMode || 2 == pageMode ? $('<section class="u-arrow-bottom"><img src="' + CLIENT_CDN + 'view/images/btn01_arrow.png" /></section>').appendTo("#page" + f) : (3 == pageMode || 4 == pageMode || 5 == pageMode) && $('<section class="u-arrow-right"><img src="' + CLIENT_CDN + 'view/images/btn01_arrow_right.png" /></section>').appendTo("#page" + f)), 1 == f && ($(".loading").hide(), $(".main-page").eq(0).addClass("z-current")), b[f - 1].properties && !$.isEmptyObject(b[f - 1].properties) ? b[f - 1].properties.image || b[f - 1].properties.scratch ? scriptLoaded.scratch ? addScratchEffect(b, f) : ! function(a) {
                $.getScript(CLIENT_CDN + "view/js/scratch_effect.js", function() {
                    scriptLoaded.scratch = !0, addScratchEffect(e, b, a)
                })
            }(f) : b[f - 1].properties.finger ? (c.push({
                num: f,
                finger: b[f - 1].properties.finger
            }), d || (d = !0, $.getScript(CLIENT_CDN + "view/js/lock_effect.js", function() {
                ...
                $.getScript(CLIENT_CDN + "view/js/falling_object.js", function() {
                ...
                {
                    eqxiu.app($(".nr"), a.obj.pageMode, b)
                }
                if ($("img").on("dragstart", function(a) {
                    a.preventDefault()
                }), !preview) {
                    var g = PREFIX_S1_URL + "eqs/pv/" + a.obj.id;
    ...
    function appendLastPage(a, b) {
        ...
        if (a.obj.createTime > 14165028e5 && !a.obj.image.hideEqAd)
            if (a.obj.image.isAdvancedUser) a.obj.property && (a.obj.property = JSON.parse(a.obj.property)), a.obj.property && a.obj.property.bottomLabel && a.obj.property.bottomLabel.id ? $.ajax({
                type: "GET",
                ...
                success: function(c) {
                    ...
                    for (d.length; e < d.length; e++) {
                        var f = d[e];
                        if (f.sceneId = a.obj.id, f.pageId = b[b.length - 1].id, a.obj.property.bottomLabel.name && a.obj.property.bottomLabel.url && "http://" != a.obj.property.bottomLabel.url) 2 == f.type && f.content.indexOf("EQXIU.COM科技公司") > 0 && (f.content = f.content.replace(/EQXIU.COM科技公司/, '<a href="http://kf.eqxiu.com:9092/eqs/link?id=' + a.obj.id + "&amp;url=" + encodeURIComponent(a.obj.property.bottomLabel.url) + '" target=_blank>' + a.obj.property.bottomLabel.name + "</a>"));
                        ...
                        else if (/好站长技术支持/.test(f.content)) {
                        ...
                        b[b.length - 1].elements.push(f)
                    }
                    eqShow.templateParser("jsonParser").parse({
                        def: b[b.length - 1],
                        appendTo: "#page" + b.length,
                        mode: "view"
                    })
                }
            }) : (d = d.replace(/id=16060/, "id=" + a.obj.id), e = e.replace(/id=16060/, "id=" + a.obj.id), b[b.length - 1].elements || (b[b.length - 1].elements = []), b[b.length - 1].elements.push(JSON.parse(d)), b[b.length - 1].elements.push(JSON.parse(e))), ad = 2;
