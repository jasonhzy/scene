        ...
        function() {
            ...
            function(a, c, d, e, f, g, h, j, k, l, m, n, o, p) {
                ...
                f.scene || (f.scene = {}), f.switchOpen = function() {
                    ...
                    f.scene.image.hideEqAd && f.userXd < 100 && (alert("秀点不足！"), f.scene.image.hideEqAd = !1)
            ...
            function(a, c, d, e, f, g) {
                ...
                function B(a) {
                    d.open({
                        ...
                        b && "http://" != b ? (a.properties.url = isNaN(b) ? PREFIX_S1_URL + "eqs/link?id=" + a.sceneId + "&url=" + encodeURIComponent(b) : b, $("#inside_" + a.id).find(".fa-link").removeClass("fa-link").addClass("fa-anchor")) : (delete a.properties.url, $("#inside_" + a.id).find(".fa-anchor").removeClass("fa-anchor").addClass("fa-link"))
                    })
                }
                var C = {},
